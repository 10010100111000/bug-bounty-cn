    ...
    <div className="space-y-12">
      ...
      <div className="grid md:grid-cols-5 gap-8">
        ...
        <div className="md:col-span-2">
          <div className="rounded-2xl overflow-hidden border border-slate-700/50 bg-slate-900/40 backdrop-blur-md shadow-sm sticky top-24">
      ...
      <div className="glass-panel overflow-hidden">
        <div className="bg-slate-900/20 px-6 py-4 border-b border-slate-700/50">
          ...
          <p className="text-sm text-slate-400 mt-1">理解两者的差异，帮你选择最适合自己的职业发展路径</p>
        </div>
            ...
            <tbody className="divide-y divide-[#e5e5e5]">
              {[
                ...
                <tr key={index} className="hover:bg-slate-900/20">
                  ...
                  <td className="py-4 px-6 text-sm text-slate-400">{row.pentest}</td>
                </tr>
              ))}
            </tbody>
          </table>
